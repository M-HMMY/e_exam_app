        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              <tr>
                <td>形式</td>
                <td>多肢選択式のみ（CBT）。記述も実技もない</td>
              </tr>
              <tr>
                <td>問題数・時間</td>
                <td>おおむね 100 問前後を 120 分。1 問あたり約 70 秒</td>
              </tr>
              <tr>
                <td>受験条件</td>
                <td>JDLA 認定プログラムを一定期間内に修了していること</td>
              </tr>
              <tr>
                <td>出題範囲</td>
                <td>応用数学・機械学習・深層学習・開発運用環境</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="hint">
問題数・試験時間・受験条件は改訂されることがあります。申し込みの前に JDLA の公式サイトで最新の要項を確認してください。
        </p>
      </section>
    </div>
  );
